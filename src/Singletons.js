...
export async function readAsDataUrlAsync(file) {
...
var l = new Logging();
l.add("Started logging in: Singleton page. ");
...
export { baseUrl, fetchUrl, Kind, white, WebRoutes, Languages, l };
